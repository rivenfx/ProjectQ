...
export interface SFMomentWidgetSchema extends SFUISchemaItem {
   ...
   */
  onOk?: (data: moment.Moment | moment.Moment[]) => void;

  /**
   * Date change callback
   */
  change?: (data: moment.Moment | moment.Moment[] | null) => void;
}
